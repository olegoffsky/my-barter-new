<?php
  ...
  $robokassa_password_2 = osp_param_update( 'robokassa_password_2', 'plugin_action', 'value_crypt', 'plugin-osclass_pay' );
       ...
       <!-- robokassa MONEY -->
        <div class="mb-method mb-robokassa <?php if($robokassa_enabled == 1) { ?>enabled<?php } ?>">
          <div class="mb-method-name">
            ...
            <span><?php _e('Robokassa Payments', 'osclass_pay'); ?></span>
            <img src="<?php echo osp_url(); ?>img/payments/robokassa.png"/>
          </div>

          <div class="mb-method-body">
            <div class="mb-row mb-method-links">
              <a href="https://robokassa.ru/" target="_blank" class="mb-prod osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-rocket"></i> <span><?php _e('Open Robokassa page', 'osclass_pay'); ?></span></a>
              <a href="https://docs.robokassa.ru/" target="_blank" class="mb-docu osp-has-tooltip" title="<?php echo osc_esc_html(__('Link will open in new window', 'osclass_pay')); ?>"><i class="fa fa-graduation-cap"></i> <span><?php _e('Open Integration Guide', 'osclass_pay'); ?></span></a>
            </div>

            <?php if(osp_currency() <> 'RUB') { ?>
              <div class="mb-row mb-errors">
                <div class="mb-line"><?php _e('Robokassa is not available, currency must be set to RUB to be able to use this gateway.', 'osclass_pay'); ?></div>
              </div>
            <?php } ?>

            <div class="mb-row mb-notes">
              <div class="mb-line"><?php _e('In your robokassa account setup notification URL into following:', 'osclass_pay'); ?></div>
              <div class="mb-line"><?php echo osc_base_url() . 'oc-content/plugins/osclass_pay/payments/robokassa/notification.php'; ?></div>
            </div>

            <div class="mb-line">
              <label for="robokassa_enabled"><span><?php _e('Enable Robokassa Payments', 'osclass_pay'); ?></span></label>
              <input name="robokassa_enabled" id="robokassa_enabled" class="element-slide" type="checkbox" <?php echo ($robokassa_enabled == 1 ? 'checked' : ''); ?> />
            </div>

            <div class="mb-line">
              <label for="robokassa_shop_login"><span><?php _e('Robokassa Shop ID (Account/Merchant)', 'osclass_pay'); ?></span></label>
              <input name="robokassa_shop_login" id="robokassa_shop_login" type="text" value="<?php echo $robokassa_shop_login; ?>" />
            </div>
            <div class="mb-line">
              <label for="robokassa_password_1"><span><?php _e('Robokassa Api Secret Key 1', 'osclass_pay'); ?></span></label>
              <input name="robokassa_password_1" id="robokassa_password_1" type="password" value="<?php echo $robokassa_password_1; ?>" />
            </div>
            <div class="mb-line">
              <label for="robokassa_password_2"><span><?php _e('Robokassa Api Secret Key 2', 'osclass_pay'); ?></span></label>
              <input name="robokassa_password_2" id="robokassa_password_2" type="password" value="<?php echo $robokassa_password_2; ?>" />
            </div>
