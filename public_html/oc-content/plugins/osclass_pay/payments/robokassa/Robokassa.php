...
class RobokassaPayment {
    ...
    public static function button($amount = '0.00', $description = '', $itemnumber = '', $extra_array = null){
        $mrhLogin = osc_get_preference('mrhlogin', 'Robokassa');
        $mrhPass1 = osc_get_preference('mrhpass1', 'Robokassa');
    ...
    $transaction_id = 'ym_' . mb_generate_rand_string(10);
		$OutSumCurrency = osc_get_preference('currency', 'Robokassa');
        ...
        $encoding = 'utf-8';
		if(osc_get_preference('robo_sandbox', 'Robokassa')==1){
		$test = 1;
		}else{
		$test = 0;
		}
