...
<li class="listing-card <?php echo $class; ?> premium" id ="<?php if (function_exists('rupayments_premium_get_class_color')){echo rupayments_premium_get_class_color(osc_premium_id());}?>">
    <?php if( osc_images_enabled_at_items() && osc_apply_filter('rupayments_item_img', rupayments_item_img(osc_premium_id()))) { ?>
