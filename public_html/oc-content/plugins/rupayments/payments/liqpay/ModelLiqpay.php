...

    {
        ...
        return sprintf('
            ...
            <form method="POST" action="%s" accept-charset="utf-8">
                ...
                <button type="submit" class="liqpay udisbutton" style="background-color:transparent!important;"><img src="' . rupayments_url() . 'payments/liqpay/liqpay-logo.svg" border="0" /></button>
