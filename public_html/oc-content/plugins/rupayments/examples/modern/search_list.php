...
<table border="0" cellspacing="0">
     <tbody>
        ...
        <?php while(osc_has_premiums()) { ?>
            <tr class="premium_<?php echo $class; ?>" id="<?php if(function_exists('rupayments_premium_get_class_color')){echo rupayments_premium_get_class_color(osc_premium_id());}?>">
                <?php if( osc_images_enabled_at_items() ) { ?>
                 <td class="photo">
                     <?php if(osc_count_premium_resources() && osc_apply_filter('rupayments_item_img', rupayments_item_img(osc_premium_id()))) { ?>
    ...
    <tbody>
        ...
        <?php while(osc_has_items()) { $i++; ?>
            <tr class="<?php echo $class; ?>">
                <?php if( osc_images_enabled_at_items() ) { ?>
                 <td class="photo" id="<?php if(function_exists('rupayments_get_class_color')){echo rupayments_get_class_color(osc_item_id());}?>">
                     <?php if(osc_count_item_resources() && osc_apply_filter('rupayments_item_img', rupayments_item_img(osc_item_id()))) { ?>
                 ...
                 <?php } ?>
                 <td class="text" id="<?php if(function_exists('rupayments_get_class_color')){echo rupayments_get_class_color(osc_item_id());}?>">
                     <h3>
