      ...
      <form action="<?php echo osc_base_url(true); ?>" method="GET" class="nocsrf" id="search-form" >
        ...
        <div class="w1">
          <div id="query-picker" class="query-picker">
            ...
            <input type="text" name="sPattern" class="pattern" placeholder="<?php _e('What are you looking for?', 'gamma'); ?>" value="<?php echo Params::getParam('sPattern'); ?>" autocomplete="off"/>
        ...
        <div class="w2">
          <div id="location-picker" class="loc-picker ctr-<?php echo (gam_count_countries() == 1 ? 'one' : 'more'); ?>">
            <div class="mini-box">
              <input type="text" id="term" class="term" placeholder="<?php _e('Everywhere', 'gamma'); ?>" value="<?php echo gam_get_term(Params::getParam('term'), Params::getParam('sCountry'), Params::getParam('sRegion'), Params::getParam('sCity')); ?>" autocomplete="off" />
        ...
        <div class="wb"><button type="submit" class="btn mbBg3"><?php _e('Search', 'gamma'); ?></button></div>
      </form>
    </div>
  </div>
...
<?php if(osc_is_home_page()) { ?>
  <div id="home-search">
    <div class="inside">
      ...
      <div class="box">
        <h1><?php _e('Sell & Buy easily', 'gamma'); ?></h2>
        ...
        <div class="wrap">
          <form action="<?php echo osc_base_url(true); ?>" method="GET" class="nocsrf" id="home-form" >
            ...
            <div class="box2 top">
              <strong><?php _e('Search', 'gamma'); ?></strong>
            ...
            <div class="box2 bot">
              <strong><?php _e('Choose location', 'gamma'); ?></strong>
            ...
            <div class="box2 but"><button type="submit" class="btn mbBg"><?php _e('Search', 'gamma'); ?></button></div>
