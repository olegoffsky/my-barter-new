<?php
  ...
  require_once ABS_PATH . 'oc-content/themes/gamma/functions.php';

  $path = osc_base_path() . 'oc-content/themes/gamma/images/favicons/';
  $url = osc_base_url() . 'oc-content/themes/gamma/images/favicons/';
?>
